...
<section id="init" class="init fullheight">
	<div class="x-container fullheight">
		<div class="flex">
			<div class="flex-50 fullheight flex-middle">
...
<section class="sectionFull" id="detail">
	<?php
		...
		foreach ($contents as $c) {
			$a=0;
			?>
		<article id="article_<?php echo $a;?>">
			<div class="x-container fullheight">
				<div class="flex">
									...
									<div class="swiper-wrapper">
										...
										?>
											<div class="swiper-slide">
												<div class="cc_rr_content_img_item" style="background-image: url('<?php echo $sl['img']; ?>');">	
													<div class="title_aa">
														<?php echo $sl['text']; ?>
													</div>
												</div>
